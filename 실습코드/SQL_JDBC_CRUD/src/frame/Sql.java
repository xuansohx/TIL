...
public class Sql {
	...
	public static String selectJoin = "select P.PDNO , P.PDNAME , F.FACTNO , F.FACNAME, P.PDSUBNAME , P.FACTNO , P.PDCOST. P.PDPRICE, P.PDAMOUNT , F.FACLOC from PRODUCTS P, FACTORY F"
